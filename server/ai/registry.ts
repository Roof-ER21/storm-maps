...
export const READ_TOOLS: ToolDef[] = [
  ...
  { name: 'aggregate_projects', description: 'Counts grouped by carrier/zip/state/stage/rep/source/type.', kind: 'read', roles: ['analytics', 'admin', 'exec'], method: 'GET', path: '/api/intel/projects-aggregate', params: obj({ group_by: str }, ['group_by']) },
  ...
  { name: 'get_carrier_deep', description: 'One-carrier deep dive.', kind: 'read', roles: 'any', method: 'GET', path: '/api/intel/carrier-deep', params: obj({ carrier: str }, ['carrier']) },
  ...
  { name: 'get_adjuster_deep', description: 'Adjuster detail (carriers, reps, history).', kind: 'read', roles: 'any', method: 'GET', path: '/api/intel/adjuster-deep', params: obj({ adjuster: str }, ['adjuster']) },
  ...
  { name: 'get_rep_deep', description: 'Rep detail. Employees: self only.', kind: 'read', roles: ['analytics', 'exec', 'admin', 'employee'], method: 'GET', path: '/api/intel/rep-deep', params: obj({ rep: str }, ['rep']) },
  ...
  { name: 'get_customer_deep', description: 'Single customer + full job history.', kind: 'read', roles: 'any', method: 'GET', path: '/api/intel/customer-deep', params: obj({ customer: str }, ['customer']) },
