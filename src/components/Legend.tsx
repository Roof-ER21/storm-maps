...
export default function Legend() {
  ...
  return (
    <div className="absolute bottom-6 right-4 z-10">
      <div className="bg-gray-950/90 backdrop-blur-sm rounded-lg shadow-lg border border-gray-700 overflow-hidden">
          ...
          <div className="px-3 pb-3 space-y-1.5">
            {HAIL_SIZE_CLASSES.map((cls) => (
              ...
              >
                ...
                {/* Size range */}
                <span className="text-gray-500 font-mono tabular-nums text-[10px]">
                  {cls.maxInches < 99
            ...
            <div className="pt-2 mt-2 border-t border-gray-700/50">
              <div className="flex items-center justify-between">
                <span className="text-[10px] text-gray-500">Roof Damage</span>
