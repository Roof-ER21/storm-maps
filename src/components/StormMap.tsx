...
function MapContent({
  ...
  return (
    <>
      ...
      {/* MRMS Hourly / Storm Timeline scrubber removed from the map per
          repeated rep feedback — too much screen real estate on phones,
          reps weren't using it. Underlying scrub state stays at null
          (merged) so the existing 24h composite renders, which is what
